...
struct GlobalConstants {
  ...
  static var storeInfoURL: String = "http://itunes.apple.com/lookup?bundleId=com.xoait.OrientExpress"
  static var itunesURL: String = "itms-apps://itunes.apple.com/us/app/apple-store/id1432206841?mt=8"
