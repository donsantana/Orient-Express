...
//  }
  ...
  func addEnvirSolictudBtn(){
    ...
    button.customBackgroundTitleColor(titleColor: nil, backgroundColor: nil)
...
//    self.navigationController?.show(vc, sender: nil)
  ...
  func crearSolicitudOferta(){
    ...
    if !self.origenCell.origenText.text!.isEmpty{
      ...
      let voucher = self.tabBar.selectedItem != self.ofertaItem && self.pagoCell.formaPagoSwitch.selectedSegmentIndex == 1 ? "1" : "0"
