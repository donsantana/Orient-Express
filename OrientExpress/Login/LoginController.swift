...
class LoginController: UIViewController, CLLocationManagerDelegate{
  ...
  override func viewDidLoad() {
    ...
    self.autenticarBtn.customBackgroundTitleColor(titleColor: nil, backgroundColor: nil)
    self.RecuperarClaveBtn.customBackgroundTitleColor(titleColor: nil, backgroundColor: nil)
    self.crearCuentaBtn.customBackgroundTitleColor(titleColor: nil, backgroundColor: nil)
