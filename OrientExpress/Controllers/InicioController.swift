...
class InicioController: BaseController, CLLocationManagerDelegate, URLSessionDelegate, URLSessionTaskDelegate, URLSessionDataDelegate, UIApplicationDelegate, UIGestureRecognizerDelegate {
  ...
  var ofertaItem = UITabBarItem(title: "", image: UIImage(named: "tipoOferta"), selectedImage: UIImage(named: "tipoOferta")!.addBorder(radius: 10, color: CustomAppColor.tabBorderColor))
  var taximetroItem = UITabBarItem(title: "", image: UIImage(named: "tipoTaximetro"), selectedImage: UIImage(named: "tipoTaximetro")!.addBorder(radius: 10, color: CustomAppColor.tabBorderColor))
  var horasItem = UITabBarItem(title: "", image: UIImage(named: "tipoHoras"), selectedImage: UIImage(named: "tipoHoras")!.addBorder(radius: 10, color: CustomAppColor.tabBorderColor))
  var pactadaItem = UITabBarItem(title: "", image: UIImage(named: "tipoPactada"), selectedImage: UIImage(named: "tipoPactada")!.addBorder(radius: 10, color: CustomAppColor.tabBorderColor))
  ...
  @IBOutlet weak var listoDestinoAddressBtn: UIButton!
  ...
  override func viewDidLoad() {
    ...
    self.LocationBtn.customImageColor(color: CustomAppColor.buttonActionColor, backgroundColor: CustomAppColor.buttonsTitleColor)
    listoAddressBtn.customBackgroundTitleColor(titleColor: nil, backgroundColor: nil)
    listoDestinoAddressBtn.customBackgroundTitleColor(titleColor: nil, backgroundColor: nil)
    self.LocationBtn.layer.cornerRadius = self.LocationBtn.frame.height/2
