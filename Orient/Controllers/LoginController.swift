...
class LoginController: UIViewController, UITextFieldDelegate, CLLocationManagerDelegate{
   ...
   // var conexion = CSocket()
    ...
    override func viewDidLoad() {
        ...
        if self.appUpdateAvailable(){
            ...
            alertaVersion.addAction(UIAlertAction(title: "Si", style: .default, handler: {alerAction in
                ...
                UIApplication.shared.openURL(URL(string: "itms-apps://itunes.apple.com/us/app/apple-store/id1432206841?mt=8")!)
            }))
    ...
    {
        let storeInfoURL: String = "http://itunes.apple.com/lookup?bundleId=com.xoait.OrientExpress"
